function o = hexb(i)
    ...
    xstring(0.85,(Tc1-6.2),'Entrada Yogurt')
    xstring(1.85,(Tc2-6.2),'Salida Yogurt')
    xstring(0.85,(Tf2-5.2),'Salida Salmuera')
    xstring(1.9,(Tf1-5),'Entrada Salmuera')
    
    xstring(0.86,(Tc1-8.2),[string(Tc1)+'ºC'])
    xstring(1.86,(Tc2-8.2),[string(Tc2)+'ºC'])
    xstring(0.86,(Tf2-7.2),[string(Tf2)+'ºC'])
    xstring(1.91,(Tf1-7),[string(Tf1)+'ºC'])
    
    xstring(1.5,36,['Calor intercambiado: Q = '+string(Q) + ' kW'])
