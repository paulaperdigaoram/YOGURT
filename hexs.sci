function o = hexs(i)
    ...
    xstring(0.91,(Tc-15),[string(Tc)+'ºC'])
    xstring(1.91,(Tc-15),[string(Tc)+'ºC'])
    xstring(0.91,(Tf1-15),[string(Tf1)+'ºC'])
    xstring(1.96,(Tf2-14),[string(Tf2)+'ºC'])
    
    xstring(1.5,30,['Calor intercambiado: Q = '+string(Q) + ' kW'])
    xstring(1.45,25,['Caudal de vapor requerido: mv = '+string(mv) + ' kg/s'])
