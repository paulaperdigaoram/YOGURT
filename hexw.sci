function o = hexw(i)
    ...
    xstring(0.8,(Tc1-8),'Entrada Leche')
    xstring(1.85,(Tc2-8.3),'Salida Leche')
    xstring(0.85,(Tf2-8.2),'Salida Agua')
    xstring(1.9,(Tf1-6),'Entrada Agua')
    
    xstring(0.81,(Tc1-12.6),[string(Tc1)+'ºC'])
    xstring(1.85,(Tc2-12.9),[string(Tc2)+'ºC'])
    xstring(0.85,(Tf2-13.8),[string(Tf2)+'ºC'])
    xstring(1.9,(Tf1-11.6),[string(Tf1)+'ºC'])
    
    xstring(1.4,91,['Calor intercambiado: Q = '+string(Q) + ' kW'])
